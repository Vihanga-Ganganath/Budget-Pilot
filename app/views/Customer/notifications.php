...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/customer-css/notifications.css?v=<?php echo @filemtime(APPROOT . '/../public/css/customer-css/notifications.css'); ?>" />
</head>
<body class="settings">
...
<script src="<?php echo URLROOT; ?>/public/js/customer-js/notifications.js?v=<?php echo @filemtime(APPROOT . '/../public/js/customer-js/notifications.js'); ?>"></script>
</body>
</html>
