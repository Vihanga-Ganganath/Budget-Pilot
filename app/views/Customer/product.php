...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/customer-css/product.css?v=<?php echo @filemtime(APPROOT . '/../public/css/customer-css/product.css'); ?>" />
</head>
<body class="settings">
...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar" aria-label="Main menu">
    ...
    <nav class="sidebar__nav" aria-label="Sections">
      ...
      <a class="navlink navlink--active" href="<?php echo URLROOT; ?>/customer/grocery" aria-current="page">
  ...
  <div class="main">
    ...
    <div class="content">
      <nav class="crumbs" aria-label="Breadcrumb">
        <a href="<?php echo URLROOT; ?>/customer/grocery">Catalog</a>
        <span aria-hidden="true">›</span>
        <a href="<?php echo URLROOT; ?>/customer/grocery" id="crumbCategory">Category</a>
        <span aria-hidden="true">›</span>
...
<script src="<?php echo URLROOT; ?>/public/js/customer-js/product.js?v=<?php echo @filemtime(APPROOT . '/../public/js/customer-js/product.js'); ?>"></script>
</body>
</html>
