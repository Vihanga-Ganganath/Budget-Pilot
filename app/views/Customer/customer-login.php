...
<main class="auth__wrap">
  ...
  <section class="auth-card">
    ...
    <div class="tabs" role="tablist" aria-label="Account type">
      <a class="tab is-active" href="customer-login.php" role="tab" aria-selected="true">Customer Account</a>
      <a class="tab" href="supplier-login.php" role="tab" aria-selected="false">Supplier Portal</a>
    </div>
    ...
    <div class="auth-card__body">
      ...
      <div class="profiles">
        ...
        <p class="profiles__empty" id="profilesEmpty" hidden>
          No profiles yet. <a class="link" href="create-account.php">Create an account</a> to get started.
        </p>
      ...
      <div class="form">
        ...
        <p class="auth__switch" id="createSwitch" hidden>New to Budget Pilot? <a class="link" href="create-account.php">Create Account</a></p>
      </div>
