...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/customer-css/expense.css?v=<?php echo @filemtime(APPROOT . '/../public/css/customer-css/expense.css'); ?>" />
</head>
<body class="settings">
...
<script src="<?php echo URLROOT; ?>/public/js/customer-js/expense.js?v=<?php echo @filemtime(APPROOT . '/../public/js/customer-js/expense.js'); ?>"></script>
</body>
</html>
